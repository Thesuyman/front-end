...
const advertising =
    {
        img1:'https://img.tgdd.vn/imgt/f_webp,fit_outside,quality_100/https://cdn.tgdd.vn//News/1510677//dien-thoai-samsung-ke-di-dau-xu-huong-17-800x450.jpg',
        img2:'https://i.ytimg.com/vi/5ZDPMJEwoYI/maxresdefault.jpg',
    }
       ...
       <div v-loading="loading" class="w-4/5 flex flex-col items-center justify-center  mx-auto">
           <CategoryProducts>
               <img :src="advertising && advertising.img1 ? advertising.img1 : ''"
                    alt="">
               <div class="flex items-center justify-center p-3 bg-black my-4 text-white font-semibold">
                    SMARTPHONE-ONE - CHUYÊN MUA BÁN VÀ PHÂN PHỐI ĐIỆN THOẠI CHẤT LƯỢNG CAO
               </div>
